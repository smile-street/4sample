...
export const ShareButton: React.FC<ShareButtonProps> = ({onClick}) => {
    const shareButtonStyles: ICommandBarStyles & IButtonStyles = {
        root: {
          ...
          height: 32,
          borderRadius: 4,
          background: radial-gradient(109.81% 107.82% at 100.1% 90.19%, rgb(230, 0, 18) 33.63%, rgb(230, 0, 18) 70.31%, rgb(230, 0, 18) 100%);
        ...
        rootHovered: {
          background: 'linear-gradient(135deg, rgb(230, 0, 18) 0%, rgb(230, 0, 18) 51.04%, rgb(230, 0, 18) 100%)',
        },
        label: {
          fontWeight: 600,
          fontSize: 14,
